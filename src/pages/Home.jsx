...
import heroGraphic from "../assets/hero-robotics-minimal.avif";
...
export default function Home() {
  ...
  return <div className="home-page">
    <section className="hero-section" ref={heroRef} onPointerMove={moveHero}>
      ...
      <div className="hero-copy"><p className="eyebrow"><span /> SDE II · Performance Platform Engineering</p><h1>Building dependable systems for machines that <em>move.</em></h1><p className="hero-lede">I’m Nikhil, an SDE II at Amazon Robotics. I build and improve fleet-scale simulation workflows, cloud infrastructure, developer UIs, and triage tooling that help engineers validate new robotic solutions with confidence.</p><div className="hero-actions"><Link className="button button-primary magnetic-button" to="/experience">Explore my work <span>↗</span></Link><a className="text-link" href="mailto:nikhilramesh1234@gmail.com">Start a conversation <span>→</span></a></div><div className="hero-meta"><span>PERFORMANCE PLATFORM</span><span>1000+ ROBOT SCALE</span><span>AMAZON ROBOTICS</span></div></div>
      <div className="hero-visual product-hero" aria-hidden="true"><div className="product-glow" /><img src={heroGraphic} alt="" /><div className="product-caption"><span>SIMULATION → VALIDATION</span><b>Built for real-world confidence.</b></div></div><p className="scroll-cue">Scroll to explore <span>↓</span></p>
    </section>
