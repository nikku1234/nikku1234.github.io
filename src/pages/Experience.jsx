...
export default function Experience() {
  ...
  return <div className="experience-page">
    ...
    <section className="role-overview"><div className="role-title"><span className="live-pill"><i /> CURRENT ROLE</span><h2>SDE II</h2><p>Performance Platform Engineering</p></div><div className="role-summary"><p>Building and improving simulation solutions that help validate new robotics systems at the scale of thousands of robots—from engine integration and cloud orchestration to UI and automated triage.</p><div className="role-stack">{["Unity", "Drake", "Unreal", "AWS", "Agentic AI"].map(item => <span key={item}>{item}</span>)}</div></div></section>
